...
--    CONSTRAINT EVENT_COMPILATION_PK PRIMARY KEY (id),
--    CONSTRAINT EVENT_COMPILATION_FK FOREIGN KEY (event_id) REFERENCES events(id),
--    CONSTRAINT EVENT_COMPILATION_FK_1 FOREIGN KEY (compilation_id) REFERENCES compilations(id)
-- );
CREATE TABLE IF NOT EXISTS event_compilation (
